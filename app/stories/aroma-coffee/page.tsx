...
// Case Study Data for Aroma Coffee & Tea
const caseStudyData = {
  id: "caffeine-usa",
  client: "Caffeine USA",
  industry: "Food & Beverage / Specialty Coffee & Beverage Distributor",
  location: "United States",
  duration: "6 weeks",
  title: "Powering Growth for a Modern Beverage Brand",
  description:
    "We designed and developed a bold, conversion-focused website for Caffeine USA that highlights their premium beverage products, communicates their brand energy, and drives wholesale inquiries and distribution partnerships across the U.S.",

  challenge:
    "Caffeine USA needed a modern, high-impact website that clearly communicated their product line, brand story, and wholesale capabilities. Their previous digital presence lacked strong branding, clear calls-to-action, and optimized structure for distributors and retail partners searching online.",

  solution:
    "We created a high-performance, visually engaging website with strong product storytelling, clear wholesale inquiry funnels, SEO-optimized content, and mobile-first design. The site features product showcases, brand messaging, distributor-focused CTAs, and streamlined contact forms to increase partnership conversions.",

  results: [
    {
      metric: "Wholesale Inquiries",
      value: "160%",
      description: "Increase in distributor inquiries",
      numericValue: 160,
      suffix: "%"
    },
    {
      ...
      value: "68%",
      description: "Increase in average session engagement",
      numericValue: 68,
      suffix: "%"
    },
    {
  ...
  features: [
    ...
    "Wholesale & distributor inquiry forms",
    "Mobile-first responsive design",
    "Brand story & mission sections",
  ...
  process: [
    {
      ...
      description:
        "Analyzed Caffeine USA’s brand positioning, target distributors, and competitive beverage landscape."
    },
    {
      step: 2,
      title: "Product Structuring",
      description:
        "Organized product categories and optimized content for clarity and SEO performance."
    },
    {
      step: 3,
      title: "Conversion Optimization",
      description:
        "Designed strategic CTAs and streamlined wholesale inquiry forms to maximize lead generation."
    },
    {
      step: 4,
      title: "Performance Launch",
      description:
        "Deployed a fast, SEO-optimized website built to scale with national distribution growth."
    }
  ],

  testimonial: {
    quote:
      "Our new website captures the bold energy of our brand and makes it easier than ever for distributors to connect with us. We've seen a major increase in serious wholesale inquiries since launch.",
    author: "Caffeine USA Team",
    role: "Management",
    company: "Caffeine USA"
  },

  liveUrl: "https://caffeineusa.com/",
  portfolioUrl: "/portfolio",

 images: [ { url: "/cofee/first-img.png", caption: "Cozy Outdoor Seating - Tujunga Village" }, { url: "/cofee/second-img.png", caption: "Artisan Coffee & Tea Selection" }, { url: "/cofee/fourth.png", caption: "Trendy Cafe Interior - Los Angeles Vibe" } ]
};
...
export default function AromaCoffeeCaseStudy() {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {[
{ color: '#F07F22', name: 'Strong Orange', usage: 'Primary accents, CTAs (Order Now), buttons, key highlights' },
{ color: '#F1E3C8', name: 'Warm Cream', usage: 'Subtle text elements, secondary accents, product details' },
{ color: '#FFFFFF', name: 'Pure White', usage: 'Backgrounds, content sections, layout spacing' },
{ color: '#000000', name: 'Jet Black', usage: 'Primary text, logos, icons and deep contrast elements' },
              ].map((c, i) => (
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <img 
                src="/cofee/text-1.png" 
                alt="Proxima Nova font sample"
                className="w-full rounded-xl shadow-sm"
              />
              <img 
                src="/cofee/text-2.png" 
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-slate-600">
                  ...
                  <span>Outdated website not matching trendy, artistic brand</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>No mobile-optimized experience for LA customers</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>Missing online ordering and gift card sales</span>
                </div>
              </div>
            </motion.div>
      ...
      <section className="px-6 py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600">Everything built for Aroma Coffee & Tea</p>
          </motion.div>
            ...
            {caseStudyData.features.map((feature, idx) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
                  ...
                  {idx === 3 && <Gift className="w-5 h-5" />}
                  {idx === 4 && <Heart className="w-5 h-5" />}
                  {idx === 5 && <Star className="w-5 h-5" />}
                  {idx === 6 && <MapPin className="w-5 h-5" />}
                  {idx === 7 && <Phone className="w-5 h-5" />}
                </div>
      ...
      <section id="process-section" className="px-6 py-20 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">How we brought Aroma Coffee online</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {caseStudyData.process.map((item, idx) => (
              ...
              >
                ...
                {activeProcess === idx && (
                  <motion.div 
                    layoutId="process-indicator-aroma"
