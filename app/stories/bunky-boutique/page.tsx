...
// Case Study Data for Bunky Boutique
const caseStudyData = {
  id: "bunky-boutique",
  ...
  duration: "7 weeks",
  title: "Bringing 17 Years of Desert Fashion into the Digital Age",
  description: "We transformed Bunky Boutique's brick-and-mortar success into a thriving online store, capturing their unique Southwest aesthetic and expanding their reach beyond Phoenix to customers nationwide.",
  challenge: "After 17 years of in-store success, Bunky needed to adapt to changing consumer habits post-pandemic. They had no e-commerce presence to sell their curated desert fashion, accessories, and home goods online, missing out on tourists and former locals who wanted to shop their unique Arizona style from anywhere.",
  solution: "Built a Shopify-powered e-commerce experience that translates their in-store vibe online, with easy product management, mobile-optimized shopping, integrated inventory, and storytelling that highlights their 17-year Phoenix heritage and local maker connections.",
  results: [
    { metric: "Online Sales", value: "280%", description: "Revenue increase in first quarter", numericValue: 280, suffix: "%" },
    { metric: "New Customers", value: "65%", description: "From outside Arizona", numericValue: 65, suffix: "%" },
    { metric: "Mobile Orders", value: "72%", description: "Of total transactions", numericValue: 72, suffix: "%" },
    { metric: "Inventory Sync", value: "100%", description: "Real-time online/offline", numericValue: 100, suffix: "%" }
  ],
  features: [
  ...
  technologies: ["Shopify", "Next.js 14", "TypeScript", "Tailwind CSS", "Shopify API", "Klaviyo", "Google Analytics", "SEO Schema"],
  process: [
    { step: 1, title: "Brand Audit", description: "Translated 17 years of in-store experience to digital" },
    { step: 2, title: "Store Design", description: "Created desert-inspired aesthetic with easy navigation" },
    { step: 3, title: "E-commerce Build", description: "Developed Shopify store with inventory integration" },
    { step: 4, title: "Launch & Growth", description: "Opened online sales to nationwide audience" }
  ],
  testimonial: {
    quote: "Going online was scary after 17 years of just in-store sales, but our new website feels exactly like walking into our Phoenix shop. We're now shipping to customers who moved away and tourists who visited once and want more. It's like having a second location that never closes.",
    author: "Bunky Boutique Team",
    role: "Owners",
    company: "Bunky Boutique"
  },
  liveUrl: "https://bunkyboutique.com/",
  portfolioUrl: "/portfolio",
  images: [
    { url: "/bunky/first-img.png", caption: "Desert Fashion - Women's Apparel Collection" },
    { url: "/bunky/forth-img.png", caption: "Curated Boutique Interior - Phoenix, AZ" },
    { url: "/bunky/third-img.png", caption: "Accessories & Home Goods - Southwest Style" }
  ]
};
...
export default function BunkyBoutiqueCaseStudy() {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {[
               { color: '#FFFFFF', name: 'Pure White', usage: 'Main background, content sections, spacing for a clean boutique layout' },
{ color: '#000000', name: 'Jet Black', usage: 'Primary text, navigation labels, icons, high-contrast elements' },
{ color: '#E30613', name: 'Bunky Red / Accent', usage: 'Logo accents and key visual highlights in branding elements' },
{ color: '#FBBF00', name: 'Golden Accent', usage: 'Secondary accent details in logo and decorative UI graphics' },
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <img 
                src="/bunky/text-1.png" 
                alt="Proxima Nova font sample"
                className="w-full rounded-xl shadow-sm"
              />
              <img 
                src="/bunky/text-2.png" 
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-slate-600">
                  ...
                  <span>No e-commerce after 17 years of in-store only</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>Missing tourists and former locals who want to shop</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>Post-pandemic shift to online shopping</span>
                </div>
              </div>
            </motion.div>
      ...
      <section className="px-6 py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600">Everything built for Bunky Boutique</p>
          </motion.div>
            ...
            {caseStudyData.features.map((feature, idx) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
                  ...
                  {idx === 4 && <Star className="w-5 h-5" />}
                  {idx === 5 && <Users className="w-5 h-5" />}
                  {idx === 6 && <Gift className="w-5 h-5" />}
                  {idx === 7 && <Calendar className="w-5 h-5" />}
                </div>
      ...
      <section id="process-section" className="px-6 py-20 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">How we brought Bunky Boutique online</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {caseStudyData.process.map((item, idx) => (
              ...
              >
                ...
                {activeProcess === idx && (
                  <motion.div 
                    layoutId="process-indicator-bunky"
