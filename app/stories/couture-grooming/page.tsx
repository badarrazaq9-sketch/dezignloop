...
// Case Study Data for Couture Grooming Inc.
const caseStudyData = {
  id: "couture-grooming",
  client: "Couture Grooming Inc.",
  industry: "Pet Services / Retail",
  location: "Bronx, New York",
  duration: "6 weeks",
  title: "Transforming a Local Pet Groomer into the Bronx's Premier Pet Destination",
  description: "We built a comprehensive digital platform for Couture Grooming Inc. that showcases their full range of pet services, drives appointment bookings, and expands their reach beyond walk-in customers in the Bronx.",
  challenge: "Couture Grooming had a basic online presence that didn't reflect their decade of expertise or their full service offerings. They struggled to communicate their unique value proposition - combining grooming, pet hotel, clinic services, and retail - while competing with larger chain pet stores in New York.",
  solution: "Created a service-focused website with online booking for grooming and hotel stays, clear service explanations, integrated pet store e-commerce, and local SEO optimization to capture 'pet grooming Bronx' searches. Emphasized their personalized care and 10+ years of community trust.",
  results: [
    { metric: "Appointments", value: "220%", description: "Increase in online bookings", numericValue: 220, suffix: "%" },
    { metric: "New Clients", value: "45%", description: "From organic local search", numericValue: 45, suffix: "%" },
    { metric: "Hotel Stays", value: "85%", description: "Booked through website", numericValue: 85, suffix: "%" },
    { metric: "Retail Sales", value: "3.5x", description: "Online store growth", numericValue: 3.5, suffix: "x", isDecimal: true }
  ],
  features: [
    "Online grooming appointment booking",
  ...
  technologies: ["Next.js 14", "TypeScript", "Tailwind CSS", "Square Appointments", "Shopify Buy Button", "Google Analytics", "Local SEO Schema"],
  process: [
    { step: 1, title: "Service Audit", description: "Mapped all services: grooming, hotel, clinic, retail" },
    { step: 2, title: "Brand Story", description: "Highlighted 10+ years of Bronx community trust" },
    { step: 3, title: "Booking Integration", description: "Built seamless appointment and reservation system" },
    { step: 4, title: "Local Launch", description: "Optimized for Bronx pet owners and nearby searches" }
  ],
  testimonial: {
    quote: "Our website now does what our old one never could - it shows customers everything we offer, not just grooming. We're booking hotel stays online, selling pet food for pickup, and new clients tell us they found us because we rank #1 for pet grooming in the Bronx. It's been a game changer.",
    author: "Couture Grooming Team",
    role: "Owners",
    company: "Couture Grooming Inc."
  },
  liveUrl: "https://www.couturegroominginc.com/",
  portfolioUrl: "/portfolio",
  images: [
    { url: "/grooming/first-img.png", caption: "Professional Pet Grooming Services" },
    { url: "/grooming/second-img.png", caption: "Pet Hotel & Boarding - Comfortable Stays" },
    { url: "/grooming/third-img.png", caption: "Pet Store - Quality Food & Supplies" }
  ]
};
...
export default function CoutureGroomingCaseStudy() {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {[
               { color: '#FFFFFF', name: 'Pure White', usage: 'Page backgrounds, section containers, spacing areas to keep the layout clean' },
{ color: '#000000', name: 'Jet Black', usage: 'Primary text, navigation labels, icons, and emphasis elements' },
{ color: '#2A2A2A', name: 'Dark Charcoal', usage: 'Secondary text, subtle UI separators, footer text' },
{ color: '#777777', name: 'Soft Gray', usage: 'Placeholder text, form field borders, less prominent UI details' },
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <img 
                src="/grooming/text-1.png" 
                alt="Proxima Nova font sample"
                className="w-full rounded-xl shadow-sm"
              />
              <img 
                src="/grooming/text-2.png" 
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-slate-600">
                  ...
                  <span>Basic website not showcasing full service offerings</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>Competing with big chain pet stores in New York</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>10+ years of expertise not communicated online</span>
                </div>
              </div>
            </motion.div>
      ...
      <section className="px-6 py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600">Everything built for Couture Grooming Inc.</p>
          </motion.div>
            ...
            {caseStudyData.features.map((feature, idx) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
                  ...
                  {idx === 6 && <Phone className="w-5 h-5" />}
                  {idx === 7 && <Dog className="w-5 h-5" />}
                </div>
      ...
      <section id="process-section" className="px-6 py-20 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">How we brought Couture Grooming online</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {caseStudyData.process.map((item, idx) => (
              ...
              >
                ...
                {activeProcess === idx && (
                  <motion.div 
                    layoutId="process-indicator-couture"
