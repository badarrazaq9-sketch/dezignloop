...
// Case Study Data for Inspire Nail Bar
const caseStudyData = {
  id: "inspire-nail-bar",
  client: "Inspire Nail Bar",
  industry: "Beauty & Wellness",
  location: "Rockville, MD 20855",
  duration: "6 weeks",
  title: "Elevating a Local Nail Salon into Rockville's Premier Beauty Destination",
  description: "We created a stunning, appointment-focused website for Inspire Nail Bar that showcases their upscale services, builds trust with luxury aesthetics, and drives bookings for this unisex nail salon.",
  challenge: "Inspire Nail Bar had no online presence to match their upscale in-salon experience. They relied on walk-ins and phone calls, missing out on younger customers who book online. They needed to communicate their premium positioning, unisex services, and unique amenities like complimentary drinks.",
  solution: "Built a visually stunning, mobile-first website with online booking integration, service menu with pricing, gallery showcasing their work, and emphasis on their unique selling points: upscale atmosphere, unisex services, skilled technicians, and complimentary beverages.",
  results: [
    { metric: "Online Bookings", value: "250%", description: "Increase in appointments", numericValue: 250, suffix: "%" },
    { metric: "Page Views", value: "12K+", description: "Monthly website visitors", numericValue: 12, suffix: "K+" },
    { metric: "Conversion", value: "18%", description: "Visitor to booking rate", numericValue: 18, suffix: "%" },
    { metric: "Reviews", value: "4.9", description: "Average Google rating", numericValue: 4.9, suffix: "", isDecimal: true }
  ],
  features: [
    "Online appointment booking system",
    "Service menu with pricing tiers",
    "Photo gallery of nail art",
    "Technician profiles & specialties",
    "Mobile-optimized design",
    "Google Business integration",
    "Customer review showcase",
    "Gift card purchasing"
  ],
  technologies: ["Next.js 14", "TypeScript", "Tailwind CSS", "Square Appointments", "Google Analytics", "Instagram API", "SEO Schema"],
  process: [
    { step: 1, title: "Brand Discovery", description: "Captured their upscale, welcoming atmosphere and unisex appeal" },
    { step: 2, title: "Visual Design", description: "Created luxury aesthetic with calming colors and elegant typography" },
    { step: 3, title: "Booking Integration", description: "Seamless Square Appointments integration for easy scheduling" },
    { step: 4, title: "Launch & Local SEO", description: "Optimized for 'nail salon Rockville MD' and surrounding areas" }
  ],
  testimonial: {
    quote: "Our website has completely transformed how customers find and book with us. We're now attracting clients who specifically mention they love our online booking and the professional look of our site. It's paid for itself in just two months.",
    author: "Inspire Nail Bar Team",
    role: "Owners",
    company: "Inspire Nail Bar"
  },
  liveUrl: "https://inspirenailbarrockville.com/",
  portfolioUrl: "/portfolio",
  images: [
    { url: "/inspire/first-img.png", caption: "Elegant Nail Art Showcase" },
    { url: "/inspire/forth-img.png", caption: "Upscale Salon Interior" },
    { url: "/inspire/second-img.png", caption: "Luxury Manicure Services" }
  ]
};
...
export default function InspireNailBarCaseStudy() {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              {[
               { color: '#997132', name: 'Dark Golden Brown', usage: 'Section headings, footer background, primary buttons, navigation bar accents' },
{ color: '#C5A545', name: 'Metallic Gold / Rich Gold', usage: 'Call-to-action buttons (Book Now), highlights, hover states, icons, decorative elements' },
{ color: '#FFFFFF', name: 'Pure White', usage: 'Main background, content sections, cards, forms, spacing areas for clean luxury feel' },
{ color: '#000000', name: 'Pure Black', usage: 'Primary text, headings contrast, icons, overlays, and emphasis elements' },
              ].map((c, i) => (
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <img 
                src="/inspire/text-1.png" 
                alt="Proxima Nova font sample"
                className="w-full rounded-xl shadow-sm"
              />
              <img 
                src="/inspire/text-2.png" 
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-slate-600">
                  ...
                  <span>No online presence matching upscale in-salon experience</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>Missing younger customers who prefer online booking</span>
                </div>
                <div className="flex items-start gap-3 text-slate-600">
                  <div className="w-2 h-2 rounded-full bg-orange-400 mt-2" />
                  <span>Reliance on walk-ins and phone calls only</span>
                </div>
              </div>
            </motion.div>
      ...
      <section className="px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Performance Impact</h2>
            <p className="text-slate-600 text-lg">Scroll down to see the numbers animate</p>
          </motion.div>
      ...
      <section className="px-6 py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Key Features Delivered</h2>
            <p className="text-slate-600">Everything built for Inspire Nail Bar</p>
          </motion.div>
            ...
            {caseStudyData.features.map((feature, idx) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center mb-4">
                  ...
                  {idx === 1 && <Scissors className="w-5 h-5" />}
                  {idx === 2 && <Gem className="w-5 h-5" />}
                  {idx === 3 && <Users className="w-5 h-5" />}
                  {idx === 4 && <Heart className="w-5 h-5" />}
                  {idx === 5 && <Star className="w-5 h-5" />}
                  {idx === 6 && <Wine className="w-5 h-5" />}
      ...
      <section id="process-section" className="px-6 py-20 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-600 text-lg">How we brought Inspire Nail Bar online</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {caseStudyData.process.map((item, idx) => (
              ...
              >
                ...
                {activeProcess === idx && (
                  <motion.div 
                    layoutId="process-indicator-nail"
