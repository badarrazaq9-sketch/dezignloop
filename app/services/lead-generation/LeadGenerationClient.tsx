...
const proofItems: ProofItem[] = [
  {
    title: 'Plumbing Company Lead Campaign',
    category: 'Meta & Google Ads',
    image: 'https://images.unsplash.com/photo-1600880292203-5fd6b9e3c3f8?auto=format&fit=crop&w=800&q=80',
    fullImage: 'https://images.unsplash.com/photo-1600880292203-5fd6b9e3c3f8?auto=format&fit=crop&w=1600&q=80',
  },
  {
    title: 'Restaurant Customer Growth',
    category: 'Organic + Paid Ads',
    image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80',
    fullImage: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=1600&q=80',
  },
  {
    title: 'HVAC Service Lead Surge',
    ...
    fullImage: 'https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?auto=format&fit=crop&w=1600&q=80',
  },
];

const service = {
  title: 'Lead Generation',
  tagline: 'Get More Calls, Bookings and Customers',
  heroHeadline: 'Predictable New Customers Every Month',
  heroSubhead: 'We bring ready-to-buy customers to your business using Meta ads, Google ads and organic methods. No guesswork. Just qualified leads that turn into paying jobs.',
  trustCopy: 'Delivered 5,000+ Leads for Local Businesses',
  icon: Target,
  heroImage: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=1200&q=80',

  whoFor: [
    'Local service businesses wanting steady new jobs',
    'Companies tired of slow seasons and empty calendars',
    'Owners ready to grow without hiring more salespeople',
    'Businesses that want customers calling them directly',
  ],

  whoNotFor: [
    'Businesses looking for free traffic only',
    'Owners not ready to handle more customer calls',
    'Companies with no budget for advertising',
    'Businesses expecting results without good service delivery',
  ],

  problems: [
    {
      problem: 'Slow seasons with few or no new customers',
      solution: 'Consistent lead flow all year using paid and organic channels.',
    },
    {
      problem: 'Relying only on word of mouth or luck',
      solution: 'Targeted ads that reach people actively searching for your service.',
    },
    {
      problem: 'Wasting money on ads that bring wrong people',
      solution: 'Precise targeting and testing that brings only qualified leads.',
    },
  ],

  deliverables: [
    'Custom ad strategy for your area and service',
    'Professional ad creatives (images + short videos)',
    'Landing page or form setup for best conversions',
    'Google Ads or Meta Ads campaign setup',
    'Lead tracking and reporting dashboard',
    'Weekly performance updates and tweaks',
    'Call and form lead delivery straight to you',
    '30 days of optimization after launch',
  ],

  timeline: 'First Leads in 7-14 Days',
  communication: 'WhatsApp, Email & Weekly Reports',

  metrics: [
    { value: '20-50', label: 'Qualified Leads Per Month (Average)' },
    { value: '2-5×', label: 'Typical Return on Ad Spend' },
    { value: '100%', label: 'You Own All Campaigns' },
  ],
  ...
  process: [
    { title: 'Strategy Call', desc: 'We learn your service area, ideal customer and past results to build the right plan.' },
    { title: 'Creative & Setup', desc: 'We create ads and landing pages that speak directly to people needing your service.' },
    { title: 'Launch & Testing', desc: 'We start campaigns small, test what works best and quickly improve results.' },
    { title: 'Scale & Optimize', desc: 'We increase spend on winning ads and keep adjusting for more and better leads.' },
  ],

  faqs: [
    {
      question: 'Do I pay for the ads separately?',
      answer: 'Yes. You pay the ad platforms (Meta/Google) directly for clicks. Our fee covers strategy, creatives, management and optimization.',
    },
    {
      question: 'What if I get no leads?',
      answer: 'We offer a money-back guarantee. If we deliver zero qualified leads in the first 30 days you get a full refund.',
    },
    {
      question: 'Can I pause or stop anytime?',
      answer: 'Yes. No long contracts. You can pause or cancel with 7 days notice. Campaigns remain yours.',
    },
    {
      question: 'How soon do leads start coming?',
      answer: 'Most clients see first leads within 7-14 days after launch. Full momentum builds in 30 days.',
    },
  ],

  addOns: [
    { title: 'Extra Ad Creatives', price: '$199', desc: '5 additional images or short videos to test more options.' },
    { title: 'Appointment Booking Setup', price: '$299', desc: 'Calendar integration so leads book directly with you.' },
    { title: 'Local SEO Boost', price: '$399/month', desc: 'Google Business optimization for more free calls.' },
  ],

  relatedServices: [
    { slug: 'web-design', title: 'Web Design', tagline: 'Professional Site to Convert Leads' },
    { slug: 'branding', title: 'Branding', tagline: 'Strong Brand That Builds Trust' },
    { slug: 'search-engine-optimization-seo', title: 'SEO Services', tagline: 'Free Organic Leads Long-Term' },
  ],
};
    ...
    <>
      ...
      <div className="pt-32 bg-white dark:bg-slate-950">
        ...
        <section className="py-24 bg-white dark:bg-slate-950">
          <div className="container mx-auto px-4">
            <SectionHeader tag="The Reality Check" title="Why Most Local Businesses Struggle for Customers" center={true} />
              ...
              <div className="lg:col-span-7">
                <div className="mb-16">
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-white">
                    Everything Needed for Steady Customer Flow
                  </h2>
                  <p className="text-lg text-white mt-4 max-w-2xl">
                    No hidden steps. Just proven setup that brings real leads to your phone and inbox.
                  </p>
                </div>
        ...
        {/* <section className="py-24 md:py-32 bg-white dark:bg-slate-950">
          <div className="container mx-auto px-4">
            <SectionHeader tag="Real Results" title="Leads That Turned Into Real Customers" center={true} />
            ...
            <div className="text-center mt-12 md:mt-16">
              ...
              >
                Ready for more customers? Let us talk <ArrowRight size={20} />
              </button>
            </div>
          </div>
        ...
        <section id="pricing" className="py-24 bg-white dark:bg-slate-950">
          <div className="container mx-auto px-4">
            <SectionHeader tag="Investment" title="Clear Monthly Pricing" description="Ad spend paid separately to Meta/Google. Our fee covers full management." center={true} />
            ...
            <div className="mt-16 max-w-3xl mx-auto">
              <h4 className="text-center font-black text-xl mb-8 text-slate-900 dark:text-white">Popular Add-Ons</h4>
        ...
        <section className="py-24 bg-gradient-to-br from-[#1C9FF0] to-[#010FFF] dark:bg-black text-white">
          <div className="container mx-auto px-4 text-center max-w-4xl">
            <h2 className="text-3xl md:text-5xl font-black mb-12">Why Local Businesses Choose Us for Leads</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                <Target className="text-white mb-6" size={32} />
                <h3 className="text-xl font-black mb-4">Local Expertise</h3>
                <p className="text-white font-medium">We know how people search and buy services in your city and target them exactly.</p>
              </div>
              <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                <Clock className="text-white mb-6" size={32} />
                <h3 className="text-xl font-black mb-4">Fast Results</h3>
                <p className="text-white font-medium">Leads start coming in days, not months. No long waiting for SEO alone.</p>
              </div>
              <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                <TrendingUp className="text-white mb-6" size={32} />
                <h3 className="text-xl font-black mb-4">Real ROI Focus</h3>
                <p className="text-white font-medium">We track every lead and dollar spent so you see clear return on investment.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-900">
          <div className="container mx-auto px-4">
            <h3 className="text-2xl font-black mb-12 text-center text-slate-900 dark:text-white">Support Your Lead Flow</h3>
