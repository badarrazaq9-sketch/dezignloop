  ...
  faqs: [
    {
      ...
      answer: 'We build native apps for both. Basic packages are single-platform, higher ones include both iOS and Android.',
    },
    {
...
export default function AppDevelopmentPage() {
  ...
  title="Custom Solutions We’ve Built"
/>
